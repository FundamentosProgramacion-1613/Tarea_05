...
def dibujarCuadrados(): 
    ...
    for f in range(20):
        ...
        area-=10
        areac-=10
        cuadrado = Rectangle((a, a), (area, area))
        cuadrado.fill = None
        cuadrado.draw(v)
        circulo = Circle((200,200), areac)
        circulo.fill = None
        circulo.draw(v)
    time.sleep(10)
    v.close()
...
def main():
    ...
    while opcion!=8 :
        ...
        if opcion == 1:
            ...
            calcularMultiplos()
            print("La cantidad de numeros divisibles entre 29 con 4 digitos son:",t)
        elif opcion == 7:
            calcularOperaciones()
        elif opcion == 8:
            print ("Adios\nBuen dia\n:)")
